package com.example.huang.thread;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void anr(View v) {
        for (int i = 0; i < 10000; i++) {
            BitmapFactory.decodeResource(getResources(), R.drawable.androidaa);
        }
    }
    ...
    public void timertask(View v) {
        ...
        Timer tiemr2 = new Timer();
        MyThread thread1 = new MyThread("线程1");
        MyThread thread2 = new MyThread("线程2");
        timer1.schedule(thread1, 0);
        tiemr2.schedule(thread2, 0);
    }
    ...
    public void asynctask(View v) {
        class LearHard extends AsyncTask<Long, String, String>{
            ...
            public LearHard(Context context) {
